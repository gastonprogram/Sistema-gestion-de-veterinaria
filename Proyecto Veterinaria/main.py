...
def main():
    ...
    archivoClientesGuardadosRuta = r".\clientes_guardados.csv"
    archivoMascotasGuardadasRuta = r".\mascotas_guardadas.csv"
    archivoProfesionalesGuardadosRuta = r".\profesionales_guardados.csv"
    archivoTurnosProgramadosRuta = r".\turnos_programados.csv"
    ...
    while True:
        ...
        if opcion_principal == "1":  # Submenú de Clientes
            while True:
                ...
                print(Fore.BLUE + "[1]" + Style.RESET_ALL + " Agregar Cliente")
                print(Fore.BLUE + "[2]" + Style.RESET_ALL + " Modificar Cliente")
                ...
                if opcion_clientes == "1":  # agregar cliente
                    ...
                    if informacionClienteModificar:
                        guardarClienteModificado(informacionClienteModificar, archivoClientesGuardadosRuta)
            ...
            while True:
                ...
                print(Fore.GREEN + "[1]" + Style.RESET_ALL + " Agregar Mascota")
                print(Fore.GREEN + "[2]" + Style.RESET_ALL + " Modificar Mascota")
            ...
            while True:
                ...
                print(Fore.RED + "[1]" + Style.RESET_ALL + " Agregar Profesional")
                print(Fore.RED + "[2]" + Style.RESET_ALL + " Modificar Profesional")
                print(Fore.RED + "[3]" + Style.RESET_ALL + " Eliminar Profesional")
                print(" ")
                print(Fore.CYAN + "="*40)
                print(Fore.CYAN + "[0]"  + " Volver al menu principal")
                print(" ")
                ...
                if opcion_profesionales == "1": #añadir profesional
                    ...
                    if infoProfesionalModificar:
                        guardarProfesionalModificado(infoProfesionalModificar, archivoProfesionalesGuardadosRuta)
            ...
            while True:
                ...
                print(Fore.WHITE + "[1]" + Style.RESET_ALL + " Programar Turno")
                print(Fore.WHITE + "[2]" + Style.RESET_ALL + " Modificar Turno")
                print(Fore.WHITE + "[3]" + Style.RESET_ALL + " Cancelar Turno")
                print(" ")
                print(Fore.CYAN + "="*40)
                print(Fore.CYAN + "[0]" + " Volver al menu principal")
                print()
                ...
                if opcion_turnos == "2": #modificar turno
                    ...
                    infoTurnoModificado = modificarTurnoCliente(archivoTurnosProgramadosRuta, archivoClientesGuardadosRuta, archivoProfesionalesGuardadosRuta)

                    #guardar la informacion del turno a modificar en la lista
                    if infoTurnoModificado:
                        guardarTurnoModificado(infoTurnoModificado, archivoTurnosProgramadosRuta)
